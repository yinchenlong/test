...
@Component({
    selector: 'app-abnormal-showed',
    templateUrl: './abnormal-showed.component.html',
    styleUrls: ['./abnormal-showed.component.css']
})
export class AbnormalShowedComponent implements OnInit {
    // 数据请求的地址
    url = '';
    ...
    queryLineChartData(dimensionValue: string): void {
        const _that = this;
        this.jsonp.get(this.url + '/wakeUpBts/getLineChartData?neCode=&dimensionType=' + dimensionValue + '&callback=JSONP_CALLBACK')
            .subscribe(
                function (data) {
                    const result = data['_body'];
                    if (result['success']) {
    ...
    queryAcitveAlarmTableDataList(dimensionValue: string): void {
        ...
        this.jsonp.get(this.url + '/wakeUpBts/getAbnormalDataList?neCode=&type=' + dimensionValue +
            '&cityCode=' + _that.activeAlarmCityCode + '&areaCode=' + _that.activeAlarmAreaCode + '&neName=' + _that.activeAlarmNeName +
            '&neVersion=' + _that.activeAlarmNeVersion + '&startTime=' + sTime + '&endTime=' + eTime + '&page=' + _that.activeAlarmPage +
    ...
    queryBtsOutageTableDataList(dimensionValue: string): void {
        ...
        this.jsonp.get(this.url + '/wakeUpBts/getAbnormalDataList?neCode=&type=' + dimensionValue + '&cityCode=' + _that.btsOutageCityCode +
            '&areaCode=' + _that.btsOutageAreaCode + '&neName=' + _that.btsOutageNeName + '&neVersion=' + _that.btsOutageNeVersion +
            '&startTime=' + sTime + '&endTime=' + eTime + '&page=' + _that.btsOutagePage +
    ...
    querySleepingCellTableDataList(dimensionValue: string): void {
        ...
        this.jsonp.get(this.url + '/wakeUpBts/getAbnormalDataList?neCode=&type=' + dimensionValue +
            '&cityCode=' + _that.sleepingCellCityCode + '&areaCode=' + _that.sleepingCellAreaCode + '&neName=' + _that.sleepingCellNeName +
            '&neVersion=' + _that.sleepingCellNeVersion + '&startTime=' + sTime + '&endTime=' + eTime + '&page=' + _that.sleepingCellPage +
