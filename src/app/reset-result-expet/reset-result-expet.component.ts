...
@Component({
    selector: 'app-reset-result-expet',
    templateUrl: './reset-result-expet.component.html',
    styleUrls: ['./reset-result-expet.component.css']
})
export class ResetResultExpetComponent implements OnInit {
    // 数据请求的地址
    url = '';
    ...
    queryTableDataList(): void {
        ...
        this.jsonp.get(this.url + '/wakeUpBts/getWakeUpResultList?exceptionType=' + _that.exceptionValue + '&cityCode=' + _that.cityCode +
            '&areaCode=' + _that.regionCode + '&neName=' + _that.neName + '&neVersion=' + _that.version + '&startTime=' + sTime +
            '&endTime=' + eTime + '&meType=' + _that.meType + '&neCode=' + _that.neCode + '&page=' + _that.tablePage + '&pageSize=' +
